...
description: The fourth part of a multi-part series on deploying Kubernetes
tags: ["kubernetes", "k8s", "deployment", "vmware", "esxi", "nfs", "storage"]
series: "Deploying Kubernetes"
---
## Introduction

This article follows part 3 of the *Deploying Kubernetes* series, where we configured File Storage that our Kubernetes cluster will come to rely on. Now, we're going to actually deploy Kubernetes itself. (Finally, right?) 
