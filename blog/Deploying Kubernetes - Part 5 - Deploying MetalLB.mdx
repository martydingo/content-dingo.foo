...
import InlineSnippet  from '@/components/BlogPost/InlineSnippet/InlineSnippet.astro'
import InlineCode from '@/components/BlogPost/InlineCode/InlineCode.astro'
...
To set up MetalLB, you will need to first create a helm configuration file called 
`helm-metallb-values.yaml`. Copy the following configuration into this file:
...
helm install -n metallb metallb metallb/metallb -f helm-metallb-values.yaml`
